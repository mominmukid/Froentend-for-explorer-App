...
function HistoryVideo() {
   return (
      <NavLink to="/video">
      <div className="flex-1 sm:flex gap-4 p-3 rounded-lg bg-gray-300 dark:bg-gray-800 transition-colors mb-5" >
         <div className="relative flex-shrink-0" >
            ...
            <span className=" w-fit absolute bottom-2 left-3 md:absolute md:bottom-2 md:right-2  bg-black bg-opacity-80 text-xs px-1 py-0.5 rounded text-white" >10:24</span>
         </div>
