...
function HistoryVideo() {
   return (
      <NavLink to="/video" className="flex-1 sm:flex gap-4 p-3 rounded-lg bg-gray-200 dark:bg-gray-800 transition-colors" >
         <div className="relative flex-shrink-0" >
            <img src="https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=200&h=112&fit=crop" alt="Video thumbnail" className="w-48 h-28 object-cover rounded-lg" />
            <span className="absolute bottom-2 right-2 bg-black bg-opacity-80 text-xs px-1 py-0.5 rounded text-white" >10:24</span>
         </div>
         <div className="flex-1 min-w-0" >
            <h3 className="font-medium mb-2">Building Modern Web Applications with React and TypeScript</h3>
