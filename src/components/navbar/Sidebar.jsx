   ...
   return (
      <>
         <div className={`${cancle ? 'hidden' : 'block'} md:hidden fixed top-0 left-0 h-screen w-[60%] sm:w-[25%] bg-white/90 flex flex-col justify-start pt-12   gap-5 items-center1 border-r-2 border-gray-400 dark:bg-[#202222]`}>
            ...
            <NavLink to="/history" className='w-full hover:bg-gray-300  cursor-pointer rounded-full flex justify-start pl-5  gap-2 p-2 transition  duration-200 ease-in-out dark:text-white dark:hover:bg-gray-800'><span className='flex justify-center items-center text-xl'><FaHistory /> </span> <span className='font-bold '>History</span></NavLink>
            {/* for Subscription for mobile screen */}
            <NavLink to="/subscription" className='w-full hover:bg-gray-200  cursor-pointer rounded-full flex justify-start pl-5  gap-2 p-2 transition duration-300 ease-in-out dark:text-white dark:hover:bg-gray-800'><span className='flex justify-center items-center text-xl'>< MdSubscriptions /> </span> <span className='font-bold '>Subsciption</span></NavLink>
            {/* for liked for mobile screen */}
            <NavLink to="/like" className='w-full hover:bg-gray-200  cursor-pointer rounded-full flex justify-start pl-5  gap-2 p-2 transition duration-300 ease-in-out dark:text-white dark:hover:bg-gray-800'><span className='flex justify-center items-center text-xl'><AiOutlineLike /> </span> <span className='font-bold '>Liked</span></NavLink>
            {/* Cancle button */}
